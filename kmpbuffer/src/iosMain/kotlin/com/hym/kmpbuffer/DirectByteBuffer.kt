 ...
 * - Bulk put methods that transfer contiguous sequences of bytes from a c array pointer into this buffer;
 * - A method for [compact] a byte buffer.
 */
class DirectByteBuffer private constructor(
    /**
     * Backing c array pointer for the buffer.
     */
    private val buffer: CArrayPointer<ByteVar>,
    /**
    ...
    /**
     * Whether the buffer owns c array pointer.
     */
    val isOwner: Boolean
) : ByteBuffer() {
    /**
    ...
    constructor(capacity: Int) : this(
        buffer = nativeHeap.allocArray<ByteVar>(capacity),
        offset = 0,
        capacity = capacity,
        position = 0,
        limit = capacity,
    ...
    companion object {
         ...
         *               - Must be ≥ 0
         *               - Must satisfy [offset] + [length] ≤ [arraySize]
         *
         * @return The new byte buffer.
         * @throws IndexOutOfBoundsException If:
         * - [offset] or [length] is negative
         * - [offset] + [length] exceeds [arraySize]
         */
        fun wrap(array: CArrayPointer<ByteVar>, arraySize: Int, offset: Int, length: Int): DirectByteBuffer {
         ...
         * @return The new byte buffer.
         */
        fun wrap(array: CArrayPointer<ByteVar>, arraySize: Int): DirectByteBuffer {
            return DirectByteBuffer(
                buffer = array,
                offset = 0,
                capacity = arraySize,
     ...
     */
    override fun put(b: Byte): DirectByteBuffer {
     ...
     * @return This buffer.
     */
    override fun unsafePut(index: Int, b: Byte): DirectByteBuffer {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun put(index: Int, b: Byte): DirectByteBuffer {
        if (isReadOnly) throw ReadOnlyBufferException()
        if (index < 0 || index >= limit) throw IndexOutOfBoundsException("Invalid index: $index")
        buffer[offset + index] = b
        return this
     ...
     * @return The new byte buffer.
     */
    override fun slice(): DirectByteBuffer {
        return DirectByteBuffer(
            buffer = buffer,
     ...
     * - [length] > [limit] - [index]
     */
    override fun slice(index: Int, length: Int): DirectByteBuffer {
     ...
     * @return The new byte buffer.
     */
    override fun duplicate(): DirectByteBuffer {
        return DirectByteBuffer(
            buffer = buffer,
            offset = offset,
            capacity = capacity,
     ...
     * @see [duplicate]
     */
    override fun asReadOnlyBuffer(): DirectByteBuffer {
        return DirectByteBuffer(
            buffer = buffer,
            offset = offset,
            capacity = capacity,
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun compact(): DirectByteBuffer {
        if (isReadOnly) throw ReadOnlyBufferException()
        if (position > 0) {
    ...
    override fun isDirect(): Boolean {
        return true // This implementation is direct
    }
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putChar(value: Char): DirectByteBuffer {
        if (isBigEndian) {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putShort(value: Short): DirectByteBuffer {
        if (isBigEndian) {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putInt(value: Int): DirectByteBuffer {
        if (isBigEndian) {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putLong(value: Long): DirectByteBuffer {
        if (isBigEndian) {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putFloat(value: Float): DirectByteBuffer {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putDouble(value: Double): DirectByteBuffer {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putChar(index: Int, value: Char): DirectByteBuffer {
        if (isBigEndian) {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putShort(index: Int, value: Short): DirectByteBuffer {
        if (isBigEndian) {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putInt(index: Int, value: Int): DirectByteBuffer {
        if (isBigEndian) {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putLong(index: Int, value: Long): DirectByteBuffer {
        if (isBigEndian) {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putFloat(index: Int, value: Float): DirectByteBuffer {
     ...
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    override fun putDouble(index: Int, value: Double): DirectByteBuffer {
        return putLong(index, value.toRawBits())
    }

    /**
     * Returns the c array that backs this buffer.
     *
     * @return The c array that backs this buffer.
     * @throws ReadOnlyBufferException If this buffer is read-only.
     */
    fun cArray(): CArrayPointer<ByteVar> {
        if (isReadOnly) throw ReadOnlyBufferException()
        return buffer
    }

    /**
     * Returns the offset within this buffer's backing c array of the first element of the buffer.
     *
     * @return The offset within this buffer's c array of the first element of the buffer.
     */
    fun cArrayOffset(): Int {
        return offset
    }

    /**
     * Releases the native memory created by this buffer.
     */
    fun release() {
        if (isOwner) {
